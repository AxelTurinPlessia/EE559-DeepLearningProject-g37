...
MODEL_PATH = '/home/lefranc/EE559-DeepLearningProject-g37/results/roberta_emoji/model'
OUTPUT_PATH = '/home/lefranc/EE559-DeepLearningProject-g37/results/analysis_step4/controlled_examples_results.csv'
...
for text_plain, text_emoji, category in pairs:
    pred_plain, prob_plain = predict(text_plain)
    pred_emoji, prob_emoji = predict(text_emoji)
