...
ROBERTA_PATH = SCRATCH_ROOT / "EE559-DeepLearningProject-g37/results/roberta_base/best_model"
...
def main():
    ...
    save_path = SCRATCH_ROOT / "results_multimodal_roberta_base"
