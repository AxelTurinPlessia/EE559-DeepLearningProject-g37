"""
Step 5: BERT-only Misogyny Detection (TEXT ONLY)
- Uses fine-tuned BERT from results_full/best_model
- Uses ONLY text from MAMI (no image, no OCR)
- Keeps same structure as multimodal/RoBERTa step 5
...
def main():
    ...
    save_path = SCRATCH_ROOT / "results_bert_mami"
