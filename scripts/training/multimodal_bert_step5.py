"""
Step 5: Multimodal Misogyny Detection (BERT + CLIP)
- Uses fine-tuned BERT from results_full/best_model
...
BERT_PATH = SCRATCH_ROOT / "results_full/best_model"
...
class MultimodalModel(nn.Module):
    ...
    def forward(self, input_ids, attention_mask, images):
        ...
        text_feat = text_out.hidden_states[-1][:, 0, :]
...
def main():
    ...
    print("\n=== TRAINING MULTIMODAL BERT (WEIGHTED) ===")
    ...
    save_path = SCRATCH_ROOT / "results_multimodal_bert_weighted"
